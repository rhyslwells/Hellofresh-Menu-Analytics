...
def fetch_countries(session: requests.Session) -> dict:
    """
    Fetch list of available countries (auth sanity check).
    Equivalent to:
    GET /countries
    """
...
def main() -> None:
    ...
    # ---- Recipe ingestion (enable once countries works) ----
